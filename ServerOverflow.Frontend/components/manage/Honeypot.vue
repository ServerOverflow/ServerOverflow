<template>
  ...
  <h2 class="text-2xl font-bold">Honeypot logs</h2>
  <p class="text mt-1">Event logs caught by every honeypot server</p>
...
const { data: logs, error, status } = await useAuthFetch(`/honeypot/search`, {
...
const iconMap = {
  'Pinged': 'fa6-solid:server',
  'Joined': 'fa6-solid:right-to-bracket',
  'Left': 'fa6-solid:right-from-bracket'
};
